...
class CreatingKeysTest extends UserZoneBase
{
    public function testCreateWordpressToken()
    {
         ...
         */
        list($userZone, $storage) = $this->getEmptyUserZoneAndStorage();
        ...
        $userZone->generateIntegrationSpecificToken(
            getenv('client_email'),
        ...
        $this->assertInstanceOf('\TwoFAS\UserZone\OAuth\Token', $token);
    ...
    public function testCreateSetupToken()
    {
        ...
        $userZone->generateOAuthSetupToken(
            getenv('client_email'),
            getenv('client_password')
        );
    ...
    public function testAttemptCreatingWithInvalidPassword()
    {
        ...
        $this->setExpectedException('\TwoFAS\UserZone\Exception\AuthorizationException');
